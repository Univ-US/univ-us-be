...
public final class LmsProfAttendanceDto {
    ...
    public static class SessionRow {
        ...
        private Long sessionId;     // STUDENT_ENROLLMENT_ATTENDANCE.STD_ENR_ATD_ID
        private String sessionDate; // TO_CHAR(STD_ENR_ATD_REG_DATE,'YYYY-MM-DD') — 별칭 date는 Oracle 예약어(ORA-00923)라 sessionDate
        private String status;      // STD_ENR_ATD_STS_CODE (PRS/LAT/ABS)
    }
    ...
    public static class LectureResDto {
        ...
        private String termCode;      // SEMESTERS.SEM_TERM (SM1/SMR/SM2/WNT)
        private Integer studentCount; // 수강생 수 (status != 'DRP')
    }
    ...
    public static class SessionResDto {
        ...
        private String status; // PRS/LAT/ABS
    }
