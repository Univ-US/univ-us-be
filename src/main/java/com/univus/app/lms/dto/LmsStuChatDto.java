 ...
 * <p>본체=CHAT_ROOM·CHAT_ROOM_MESSAGES·ROOM_MESSAGES_READ. 교수 채팅 BE 미구현이라 PLM 정본 없음 → DB 컬럼에 직접 도큐트린 적용.
 ...
 */
public final class LmsStuChatDto {

    private LmsStuChatDto() {
    }
    ...
    public static class ChatRoomResDto {
        ...
        private String professorName;    // 교수 MEMBER_NAME (조인)
    ...
    public static class ChatMessageResDto {
        ...
        private String sender;           // 'me'/'professor' (CASE 파생 → 의미명)
