...
@Mapper
public interface LmsProfProfileMapper {
    // 조회 (MEMBER + MEMBER_DETAIL + DEPARTMENT + LMS_PROFILE + 최신 유효 이미지)
    LmsProfProfileDto findLmsprofessorProfileByMemberId(@Param("memberId") Long memberId);
    ...
    void updateLmsProfessorProfile(@Param("memberId") Long memberId,
                                   @Param("dto") LmsProfProfileDto.ReqDto lmsProfessorProfileUpdateDto);
